...
想过没有？下载一个文件，从近的地方下载，很快，但从远的地方下载，慢，慢一点我也不会怀疑，问题是慢很多，几兆每秒，慢成几十K，几K。慢，是应该的？或是线路不行？
...
另附一个黑客向办法：在流量经过的网关，借助iptables把udp跳转到自己端口，然后去/proc/net/nf_conntrack里找出源目的地，透明转发。
