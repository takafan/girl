...
小微流量，原本需依赖tcp的重传到达目的地/从目的地返回，换一条通畅线路，延迟可以降低到和ping包一致。体现在游戏上就是读条和转圈变得很快。

大流量，体现在下载上就是下载速度从几K，几十K，变成几M，甚至几十M。
...
1. 部分光猫udp映射端口会在极短时间内变僵尸，后续流量全部丢失。这些光猫dns解析也经常超时。
